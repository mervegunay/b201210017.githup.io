...
<head>
    ...
    <script src="https://kit.fontawesome.com/c20485228a.js" crossorigin="anonymous"></script>  <!--ICON-->

    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-wEmeIV1mKuiNpC+IOBjI7aAzPcEZeedi5yW5f2yOq55WWLwNGmvvx4Um1vskeMj0" crossorigin="anonymous">
    <link rel="stylesheet" href="css/style.css">

    <link href="https://fonts.googleapis.com/css2?family=Raleway:wght@300&display=swap" rel="stylesheet"> <!--YAZISTİLİ-->
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/siirt4.jpg" class="d-block w-100 resimSlider" alt="Görsele ulaşılamıyor.">
            </div>
            <div class="carousel-item">
                <img src="img/siirt7.jpg" class="d-block w-100 resimSlider" alt="Görsele ulaşılamıyor.">
            </div>
            <div class="carousel-item">
                <img src="img/siirt5.jpeg" class="d-block w-100 resimSlider" alt="Görsele ulaşılamıyor.">
            </div>
        </div>
