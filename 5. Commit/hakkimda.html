...
<head>
    ...
    <title>Anasayfa | Siirt ve Ben</title>
</head>
...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <center>
        <h2 class="mb-5 font-weight-bold ">KENDİM HAKKINDA</h2>
    </center>

    <div class="ornek">
        <img src="img/Vesikalık.jpg" class="sola-kaydir">
        <p>İsim:Merve </p>
        <p> Soy İsim:Günay </p>
        <p> Yaş:21 </p>
        <p> Doğduğu il:Adana </p>
        <p> Okuduğu üniversite:Sakarya Üniversitesi </p>
        <p> Bölümü:Bilgisayar Mühendisliği </p>
        <p> Hobiler:Voleybol,resim çizmek,kitap okumak,yüzme,dizi,film,satranç.</p>
        <p> Bildiği Diller:İngilizce,Almanca</p>
        <p> Kısaca Hayatım:23 Nisan 2001 yılında Adana'da doğdum. Annem ev hanımı babam emekli polis memuru. 19 yaşında bir tane kardeşim olmakta. Ben ise şu an Sakarya Üniversitesi'nde bilgisayar mühendisliği 1. sınıf öğrencisiyim.</p>
        <br><br><br><br><br><br>
       
    </div>
    
    <div class="bg-dark text-light text-center mb-0 ">
        <p class="align-middle p-2 mb-2 ">
